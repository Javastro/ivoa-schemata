...
<!-- ***** BEGIN LICENSE BLOCK *****
   ...
   Adapted from the firefox built-in stylesheet to make more cross-browser by Paul Harrison, ESO
   basically included dumbed-down javascript and made the event handling more explicit rather than relying on global stuff.
   $Id: XMLPretty.xsl,v 1.1 2008/10/08 14:14:49 pah Exp $
   -->
...
<xsl:stylesheet version="1.0"
 ...
 <script language="JavaScript" type="text/JavaScript" src="expander.js"/>
...
-->
  ...
  <xsl:template name="expander">
    <td class="expander" onclick="expander(event);" >&#x2212;<div class="spacer"/></td>
  </xsl:template>
